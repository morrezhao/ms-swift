...
class SwiftMixin:
    ...
    def __init__(self,
        ...
        # Use data_collator from kwargs if already set (e.g., by GRPO trainer), otherwise create one
        data_collator = kwargs.pop('data_collator', None) or self._get_data_collator(args, template)
